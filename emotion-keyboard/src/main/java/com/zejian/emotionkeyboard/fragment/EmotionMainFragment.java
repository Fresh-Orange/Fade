...
//        linearLayout_Bold = (LinearLayout)rootView.findViewById(R.id.rl_editbar_bg);
//        imageView = (ImageView) rootView.findViewById(R.id.img_bold);

//        if (linearLayout_Bold != null)
//        imageView.setOnClickListener(this);

//        if (!EmotionKeyboard.isHidden) {
...
//        if (i == R.id.img_bold) {
//            if (tag == 0) {
////                Toast.makeText(mainActivity.this, "Bold on", Toast.LENGTH_SHORT).show();
//                imageView.setImageResource(R.drawable.ic_editor_bar_rtf_bold_on);
//                tag = 1;
//                //edit_temp.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
//            } else if (tag == 1) {
//                imageView.setImageResource(R.drawable.ic_editor_bar_rtf_bold_off);
//                tag = 0;
