...
import com.sysu.pro.fade.message.ViewHolder.CommentViewHolder;
...
public class CommentAdapter extends DBaseRecyclerViewAdapter<Comment> {
...
//    }
    ...
    protected DBaseRecyclerViewHolder onCreateViewHolder1(ViewGroup parent, int viewType) {
        return new CommentViewHolder(context,parent, R.layout.item_notification_comment, this);
    }
