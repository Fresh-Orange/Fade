package com.sysu.pro.fade.publish.imageselector.utils;
...
public class ImageSelectorUtils {
     ...
     * @param requestCode
     */
//    public static void openPhoto(Activity activity, int requestCode, ArrayList<String> images, int newCount) {
//        openPhoto(activity, requestCode, false, 0, images, newCount);
//    }
...
//     * @param isSingle       是否单选
    ...
    public static void openPhoto(Activity activity, int requestCode,
                                 ...
                                 int newCount) {
        ImageSelectorActivity.openActivity(activity, requestCode, maxSelectCount, images, newCount);
    }
}
